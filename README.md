...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/twilight-waterfall-f22c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-waterfall-f22c
```

A live public deployment of this template is available at [https://twilight-waterfall-f22c.templates.workers.dev](https://twilight-waterfall-f22c.templates.workers.dev)
